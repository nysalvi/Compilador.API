        ...
        public void Lexico(string args)
        {
            ...
            for (int i = 0; i < current.Length; i++)
            {
                ...
                else if (id == 55)
                {
                    ...
                    {
                        tokens.Add(new Token(59, currentLexeme + current[i]));
                        currentLexeme = "";
                        id = 0;
                    }
                    else if (current[i] == '-')
                ...
                else if (id == 56)
                {
                    ...
                    {
                        tokens.Add(new Token(60, currentLexeme + current[i]));
                        currentLexeme = "";
                        id = 0;
                    }
                    else if (current[i] == '-')
                ...
                else if (id == 57)
                {
                    if (current[i] == '=')
                    {
                        tokens.Add(new Token(61, currentLexeme + current[i]));
                        currentLexeme = "";
                        id = 0;
                    }
                    else if (current[i] == ' ')
                ...
                else if (id == 58)
                {
                    if (current[i] == '=')
                    {
                        tokens.Add(new Token(62, currentLexeme + current[i]));
                        currentLexeme = "";
                        id = 0;
                    }
                    else if (current[i] == ' ')
                ...
                else if (id == 63)
                {
                    if (current[i] == '|')
                    {
                        tokens.Add(new Token(64, currentLexeme + current[i]));
                        currentLexeme = "";
                        id = 0;
                    }
                    else
                ...
                else if (id == 65)
                {
                    if (current[i] == '&')
                    {
                        tokens.Add(new Token(66, currentLexeme + current[i]));
                        currentLexeme = "";
                        id = 0;
                    }
                    else
